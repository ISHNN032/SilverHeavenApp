...
//
//internal class RecruitViewModelTest {
//
//    @get:Rule
...
//        // given
//        coEvery { getSessionsUseCase() } returns flowOf(listOf(fakeRecruit))
...
//            val actual = (awaitItem() as? SessionUiState.Sessions)?.recruits?.first()
//            assertEquals(fakeRecruit, actual)
//        }
//    }
//}
